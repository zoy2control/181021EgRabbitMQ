...
import CH4com.rabbitmq.spring.adapter.MessageDelegate;
import CH4com.rabbitmq.spring.convert.TextMessageConverter;
...
@ComponentScan({"CH4com.rabbitmq.spring.CH4S2P1RabbitAdmin.*"}) // ·要扫描的包路径
